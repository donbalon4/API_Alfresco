...
$url = 'http://192.168.1.139:8080/alfresco/cmisws/';  // URL for repository
...
/*
$cmisServices = array(  // service endpoints for CMIS services, appended to $url
    'RepositoryService' => 'cmis?wsdl',
    'DiscoveryService' => '/cmis?wsdl',
    'MultiFilingService' => '/cmis?wsdl',
    'NavigationService' => '/cmis?wsdl',
    'ObjectService' => '/cmis?wsdl',
    'PolicyService' => '/cmis?wsdl',
    'RelationshipService' => '/cmis?wsdl',
    'VersioningService' => '/cmis?wsdl',
    'ACLService' => '/cmis?wsdl',
);*/
...
echo "<br>cmisopciones =";
var_dump($cmisSessionOptions);
echo "<br>";
